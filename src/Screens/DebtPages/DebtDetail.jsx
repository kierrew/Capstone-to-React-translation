...
const DebtDetailScreen = () => {
  ...
  return (
    <div className="App">
      <CustomNavbar />
      <header className="App-header">Debt Details</header>
      <body className="App-body">
        <p>Here are the details of the selected debt.</p>
        <form onSubmit={updateDebt}>
          ...
          <p>
            <Button variant="secondary" size="lg" onClick={setEdit}>
              Edit Debt
            </Button>
          </p>
          <p>
          ...
          <p>
            <Button variant="secondary" size="lg" onClick={payoff}>
              Payoff Schedule
            </Button>
          </p>
        </form>
