...
const MyRoutes = () => {
		const routes = [
			...
			{path: '/addDebt/:keyCode', element: 
				<ProtectedRoutes>
					<AddDebtScreen	/>,
				</ProtectedRoutes>
			},
			{path: '/debtDetail/:debtTitle/:debtInterest/:debtBalance/:debtCategory/:debtID/:debtOriginal/:keyCode', element: 
				<ProtectedRoutes>
					<DebtDetailScreen	/>,
				</ProtectedRoutes>
			},
			{path: '/debtPayoff/:debtTitle/:debtInterest/:debtBalance/:debtOriginal/:debtCategory', element: 
				<ProtectedRoutes>
					<DebtPayoffScreen	/>,
				</ProtectedRoutes>
			},
